...
This layer is referenced by the scoring methodology but is **not yet in the repo**:

| File | Used for | Required fields |
|---|---|---|
| `TAZ_1270.shp` | Population & jobs 2050 in 500 / 1000 / 1500 m rings | `POP_2050`, `EMPL_2050` |

Until it is present, `hubs validate` reports it as missing and `hubs run` refuses to

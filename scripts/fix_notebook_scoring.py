        ...
        if cell['cell_type'] == 'markdown':
            ...
            if 'Step 4.3' in source and 'Mode' in source:
                ...
                if i + 1 < len(nb['cells']) and nb['cells'][i + 1]['cell_type'] == 'code':
                    ...
                    # Check if it already has the fixes including parse_string_list
                    if 'calculate_mode_score' in source and 'get_region_category' in source and 'parse_string_list' in source:
                        print(f"   ⚠ Cell {i+1} already has fixes including parse_string_list, skipping")
                    else:
